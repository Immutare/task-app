...
public class DBUtil {
    ...
    public static List<taskTask> DBGetAllTask(TaskDB taskDBInstance, Context context){
        GetAllTask getAllTask = new GetAllTask(taskDBInstance, context);
        getAllTask.execute();
        return tasks;
    }

    public static void DBSaveNewTask(TaskDB taskDBInstance, taskTask task){
    ...
    private static class GetAllTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(final Void... params) {
            ...
            Log.d("CEGG ", tasks.size() + " Tasks in DB");
            return null;
        }
        ...
        {
            Log.d("CEGG Broadcast ", "TasksReady");
            Intent intent = new Intent();
            intent.setAction("com.CEGG.CUSTOM_INTENT.TasksReady");
    ...
    private static class SaveNewTask extends AsyncTask<Void, Void, Void> {
        ...
        public SaveNewTask(TaskDB taskDBInstance, taskTask task) {
            this.taskDBInstance = taskDBInstance;
            this.task = task;
        }
    ...
    private static class TaskCount extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void v)
        {
            Log.d("CEGG Broadcast ", "TasksCountReady");
            Intent intent = new Intent();
            intent.setAction("com.CEGG.CUSTOM_INTENT.TasksCountReady");
            context.sendBroadcast(intent);
